...
public class GeneratorHealthController : BaseController<GeneratorHealthModel, GeneratorHealthView>
{
    public GeneratorHealthController(GeneratorHealthModel model, GeneratorHealthView view) : base(model, view)
    {
    }
    ...
    public void ApplyDamage(ApplyDamageCommand command)
    {
        ...
        Debug.Log("Gen Health: " + _model.CurrentHealth.Value);
    }
